...
public class SysServerAPI {
    ...
    @LoginToken(validBackend = true,permissionKey = "lyfsysPermissionKey-system_server_getServerInfo")
...
//        double userCpuTime = osBean.getProcessCpuTime(); // 以纳秒为单位
    ...
    @LoginToken(validBackend = true,permissionKey = "lyfsysPermissionKey-system_server_getCacheInfo")
    ...
    @LoginToken(validBackend = true,permissionKey = "lyfsysPermissionKey-system_server_deleteCache")
